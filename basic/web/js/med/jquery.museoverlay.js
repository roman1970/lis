...
;(function(){if(!("undefined"==typeof Muse||"undefined"==typeof Muse.assets)){var a=function(a,b){for(var c=0,d=a.length;c<d;c++)if(a[c]==b)return c;return-1}(Muse.assets.required,"jquery.museoverlay.js"/*tpa=http://wp-media.ru/js/med/jquery.museoverlay.js*/);if(-1!=a){Muse.assets.required.splice(a,1);for(var a=document.getElementsByTagName("meta"),b=0,c=a.length;b<c;b++){var d=a[b];if("generator"==d.getAttribute("name")){"http://wp-media.ru/js/med/2014.2.1.284"!=d.getAttribute("content")&&Muse.assets.outOfDate.push("jquery.museoverlay.js"/*tpa=http://wp-media.ru/js/med/jquery.museoverlay.js*/);break}}}}})();
