...
<div class="site-index">
    ...
    <div class="jumbotron">
        ...
        */ ?>
        ...
        <a onclick="recurOneLinkedList()" class="testLink">32 Вывод односвязного списка рекурсией</a><br>
                <pre class="brush: js;" id="code_32">
        ...
        <a onclick="anagramClean()" class="testLink">35 Отфильтровать анаграммы </a><br>
                <pre class="brush: js;" id="code_35">
        ...
        <a onclick="getUnicSlow()" class="testLink">36 Уникальные элементы массива Решение перебором (медленное)</a><br>
                <pre class="brush: js;" id="code_36">
        ...
        <a onclick="arrOfLengthsOfElementsByMap()" class="testLink">37 Получение массива длин элементов входного массива</a><br>
                <pre class="brush: js;" id="code_37">
